...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\schubert_f\Projects\Python\poind\poindenv'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\schubert_f\Projects\Python\poind\poindenv\Scripts\deactivate.nu'
